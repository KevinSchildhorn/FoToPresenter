...
class RetrieveDirectoryContentsUseCaseTest : KoinTest {
    ...
    @Test
    fun `receive directory content success`() = runBlocking {
        val result = useCase("")
    ...
    @Test
    fun `receive directory content only directories`() = runBlocking {
    ...
    @Test
    fun `receive directory content failure`() = runBlocking {
    ...
    @Test
    fun `receive directory content disconnected`() = runBlocking {
        MockNetworkHandler.disconnect()
        try {

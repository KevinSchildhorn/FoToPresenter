...
class DirectoryNavigatorTest : KoinTest {
    ...
    @Test
    fun `refresh_directory_contents_success`() = runTest(testDispatcher) {
    ...
    @Test
    fun `navigate_into_directory_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
            awaitItem()
    ...
    @Test
    fun `navigate_back_to_directory_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
    ...
    @Test
    fun `set_sort_type_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
    ...
    @Test
    fun `set_search_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
            awaitItem()
    ...
    @Test
    fun `get_directory_from_id_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
            awaitItem()
    ...
    @Test
    fun `navigate_into_directory_failure`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
            awaitItem() // Initial state
    ...
    @Test
    fun `navigate_back_to_directory_failure`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        directoryNavigator.currentDirectoryContents.test {
            directoryNavigator.refreshDirectoryContents()
            awaitItem() // Initial state
    ...
    @Test
    fun `disconnected_network_failure`() = runTest(testDispatcher) {
        MockNetworkHandler.disconnect()

...
class ImagePreviewNavigatorTest : KoinTest {
    ...
    private val imageDirectories = listOf(
    ...
    @Test
    fun `set_folder_contents_success`() = runTest(testDispatcher) {
    ...
    @Test
    fun `set_image_index_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `set_image_index_null_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `show_previous_image_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `show_previous_image_wrap_around_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `show_next_image_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `show_next_image_wrap_around_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `show_next_previous_image_sequence_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())
    ...
    @Test
    fun `empty_directory_list_success`() = runTest(testDispatcher) {
        MockNetworkHandler.connectSuccessfully()
        imagePreviewNavigator.imagePreviewState.test {
            // Initial state should be null
            assertNull(awaitItem())

...
object TestingHTTPHandler : NetworkHandler {
            ...
            Path.EMPTY to
                listOf<NetworkDirectoryDetails>(
                    ...
                    DefaultNetworkDirectoryDetails(
                        fullPath =
                            Path(
                                "https://img.freepik.com/premium-photo/congo-grey-parrot-bird-illustration-png_53876-1007492.jpg",
                            ),
                        id = 75,
                    ),
                ),
    ...
    override suspend fun getDirectoryContents(path: Path): List<NetworkDirectoryDetails> = networkContents[path] ?: emptyList()
